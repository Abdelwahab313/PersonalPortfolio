...
To view a live example, **[click here](https://abdelwahab.dev/)**.
...
- Navigate to `package.json` and enter your domain name instead of `https://abdelwahab.dev/` in `homepage` variable. For example, if you want your site to be `https://<your-username>.github.io/developerFolio`, add the same to the homepage section of `package.json`.
